...
file_id = "1okk3ylnHSc-nh8k1ydc2ppeqaWqcFUyn"
...
Finalmente, para poder hacer una tabla con todos los datos para poder trabajar con Machine learning, hacemos un doble merge usando como base la tabla de transacciones. prueba
...
```{python}
#| colab: {base_uri: https://localhost:8080/, height: 207}
data.head()
```
